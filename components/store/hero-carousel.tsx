...
const SLIDES: Slide[] = [
  {
    ...
    imagePosition: "72% 15%",
    heading: ["BORDADO", "À MÃO"],
    body: "Bolsas, batas e vestidos com bordado autoral. Mais de 20 anos de trabalho à mão.",
    cta: { label: "VER LANÇAMENTOS", href: "/lancamentos" },
  },
  {
    id: 2,
    image: "/images/refs2/hero2-image.png",
    imagePosition: "50% 75%",
    heading: ["BOLSAS", "DE LONA", "E COURO"],
    body: "Bolsas em lona e couro legítimo, com desenho autoral aplicado no bordado.",
    cta: { label: "VER BOLSAS", href: "/bolsas" },
  },
  {
    id: 3,
    image: "/images/refs2/hero3-image.png",
    heading: ["PARA AS", "CRIANÇAS"],
    body: "Batas e vestidos infantis em algodão, com o mesmo bordado das peças adultas.",
    cta: { label: "VER INFANTIL", href: "/infantil" },
  },
  {
    id: 4,
    ...
    body: "Poste as peças, divulgue seu cupom e receba comissão por cada venda.",
    cta: { label: "FALAR NO WHATSAPP", href: "https://wa.me/5522988223993?text=Olá!%20Quero%20saber%20mais%20sobre%20o%20programa%20de%20afiliadas." },
  },
]
