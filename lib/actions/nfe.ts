...
// ─────────────────────────────────────────────────────────────────────────────
// emitirNfe — chamado pelo webhook de pagamento (varejo) ou botão admin (atacado)
// ─────────────────────────────────────────────────────────────────────────────

export async function emitirNfe(orderId: string): Promise<ActionResult> {
  const supabase = createServiceClient()
...
// ─────────────────────────────────────────────────────────────────────────────
// cancelarNfe — chamado pelo admin ao cancelar pedido com NF-e autorizada
// ─────────────────────────────────────────────────────────────────────────────

export async function cancelarNfe(orderId: string): Promise<ActionResult> {
  const supabase = createServiceClient()
